...
void displayList(std::shared_ptr<ListInterface<std::string>> listPtr) {
...
void listTester(std::shared_ptr<ListInterface<std::string>> listPtr) {
...
int main() {
  auto listPtr = std::make_shared<LinkedList<std::string>>();
  listTester(listPtr);
  return 0;
}  // end main
